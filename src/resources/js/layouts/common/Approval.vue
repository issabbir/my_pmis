<template>
    <div>
        <b-modal ref="approve_modal" size="xl" :title="title" :hide-footer="true" @close="hide">
                                ...
                                <!--<div v-if="next_step">
                                    <div v-if="next_step.workflow_key == 'APPROVED'" class="d-flex w-100 justify-content-center">
                                        <b-card bg-variant="dark" text-variant="white" :title="nextState.status_name">
                                            <b-card-text>All approval process has been done. Now the application ready to approve.
                                            ...
                                            <b-button type="button" :disabled="!hasPermission(next_step.user_role)" variant="primary" @click="confirmShow = true" >Approve</b-button>
                                    ...
                                    <div v-else>
                                        <b-form-group label="Change state to" label-for="from-state">
                                            <b-form-select
                                                v-model="workflow.workflow_step_id"
                                                :options="options"
                                            ></b-form-select>
                                        </b-form-group>
                                        <b-form-group label="Note" label-for="workflow-note">
                                        ...
                                        <div>
                                            <b-button type="button" :disabled="!hasPermission(next_step.user_role)" variant="dark" @click="addState(next_step)"><i class='bx bxs-send'></i> Update State</b-button>
