    ...
    <div>
        ...
        <b-row>
            ...
            <b-col md="4" class="d-flex justify-content-center">
                <b-form-group>
                    <img id="" :src="employee.emp_photo ? employee.emp_photo : '/images/avatar.png'" width="150" height="150" alt="...">
                </b-form-group>
            </b-col>
        </b-row>
        <b-row>
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.emp_maritial_status_id)?'':employee.emp_maritial_status_id.text" id="marital_status" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.emp_nationality_id)?'':employee.emp_nationality_id.text" id="nationality" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.auth_doc_type_id)?'':employee.auth_doc_type_id.text" id="auth_doc_type_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
        ...
        <b-row>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.dpt_division_id)?'':employee.dpt_division_id.text" id="dpt_division_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.dpt_department_id)?'':employee.dpt_department_id.text" id="department_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.section_id)?'':employee.section_id.text" id="dpt_section" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.designation_name)?'':employee.designation_name.designation" id="designation" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.emp_type_id)?'':employee.emp_type_id.text" id="emp_type_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input class="text-right" :value="(!employee.emp_grade_id)?'':employee.emp_grade_id.text" id="grade_range" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-for="basic_amt"
                    label-cols-md="3">
                    <b-form-input class="text-right" :value="(!employee.grade_step_id)?'':employee.grade_step_id.text" id="basic_amt" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.emp_quota_id)?'':employee.emp_quota_id.text" id="quota_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.emp_status_id)?'':employee.emp_status_id.text" id="emp_status" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-for="post_type"
                    label-cols-md="3">
                    <b-form-input :value="(!employee.post_type_id)?'':employee.post_type_id.text" id="post_type" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.reporting_officer)?'':employee.reporting_officer.option_name" id="option_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.appointment_type_id)?'':employee.appointment_type_id.text" id="appoinment_type" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                ...
                <b-form-group
                  ...
                  label-for="merit_position">
                    <b-form-input id="merit_position"
                                  name="merit_position"
                                  v-model="employee.merit_position"
                                  disabled
                    >
                    </b-form-input>
                </b-form-group>
        ...
        <b-row>
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.location_id)?'':employee.location_id.text" id="working_location" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                        ...
                        label-for="bank_name"
                        label-cols-md="3">
                    <b-form-input :value="(!employee.bank_id)?'':employee.bank_id.text" id="bank_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            ...
            <b-col md="4">
                <b-form-group
                        ...
                        label-cols-md="3">
                    <b-form-input :value="(!employee.branch_id)?'':employee.branch_id.text" id="branch_name" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.biller_code)?'':employee.biller_code.text" id="biller_code" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="(!employee.emp_emergency_relation_id)?'':employee.emp_emergency_relation_id.text" id="relation_type" disabled></b-form-input>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
            ...
            <!--<b-col md="4">
                <b-form-group
                    ...
                    label-cols-md="3">
                    <b-form-input :value="approval" id="approved_yn" disabled></b-form-input>
                </b-form-group>
            </b-col>-->
        </b-row>
    </div>
