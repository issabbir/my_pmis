                                                    ...
                                                    <b-input-group>
                                                        <b-form-group :style="family.emp_family_id && family.auth_attachment?'width: 90%;':'width: 100%;'"
                                                            ...
                                                            <div class="custom-file b-form-file">
                                                                ...
                                                                <span :style="errorMessage">{{ errors.first('auth_attachment') }}</span>
                                                            </div>
                                                        </b-form-group>
                                                        <b-input-group-append v-if="family.emp_family_id && family.auth_attachment" style="width: 10%">
                                                            ...
                                                            >
                                                                <b-button style="margin-top: 20px" class="btn btn-primary" @click="showAttachment(family.emp_family_id)"> <i class="fa fa-download"></i> </b-button>
                                                            </b-form-group>
