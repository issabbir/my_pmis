...
<script>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                fields: [
                    ...
                    {key: 'punishment_type', label:'Punishment Type', sortable: true},
                    {key: 'punishment_date', label:'Punishment Date', sortable: true},
        ...
        methods: {
            ...
            loadData: function() {
                if(this.hasEmpId()) {
                    ApiRepository.callApi(ApiRepository.GET_COMMAND, `/pmis/employee/punishments/specific/${this.id}`).then(res => {
                        this.items = res.data;
