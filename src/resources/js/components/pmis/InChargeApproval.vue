<template>
    <div class="content-wrapper">
        <div class="content-body">
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">In Charge Search </b-card-header>
                <b-card-body class="border">
                    <b-form>
                        <b-row>
                            ...
                            <b-col md="4">
                                <b-button type="submit" id="basic_sub_btn" @click="searchInCharge" class="btn btn-dark shadow mr-1 mb-1">Search</b-button>
                            </b-col>
                        </b-row>
            ...
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">Pending In Charge For Approval</b-card-header>
                <b-card-body class="border">
                    <b-form
    ...
    export default {
            ...
            return{
                ...
                tableData: {
                    fields: [
                        ...
                        {key: 'charge_type_name', label: 'Charge Type', sortable: true},
        ...
        methods: {
            searchInCharge() {
                ...
                ApiRepository.callApi(ApiRepository.GET_COMMAND, `/pmis/unapproved-in-charge?emp_id=`+empId).then(res => {
            ...
            onProcess() {
                ...
                let empId = this.inChargeSearch.emp_id;
                ApiRepository.callApi(ApiRepository.PUT_COMMAND, `/pmis/charge-entry-approval?emp_id=`+empId, obj).then(res => {
