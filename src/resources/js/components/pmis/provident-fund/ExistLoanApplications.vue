                ...
                <b-card-body class="border">
                    <b-form @submit.prevent="onSubmit" @reset.prevent="onReset">
                        <b-row>
                            ...
                            <b-col md="4">
                                <b-form-group label="Open Date" label-for="open_date" class="required">
                                    <date-picker
                                        width="100%"
                            ...
                            <b-col md="4">
                                <b-form-group label="Loan amount" label-for="loan_amount" class="required">
                                    <b-form-input v-model="loanApplication.loan_amount" number class="text-right" required
                                                  id="loan_amount"></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="4">
                                <b-form-group label="Installment No" label-for="installment_no" class="required">
                                    <b-form-input v-model="loanApplication.installment_no" number required
                                                  id="installment_no"></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="4">
                                <b-form-group label="First Disbursement Date" label-for="first_disbursement_date" class="required">
                                    <date-picker
                                        width="100%"
                                        input-class="form-control"
                            ...
                            <b-col md="4">
                                <b-form-group label="Disbursement Amount" label-for="disbursement_amt" class="required">
                                    <b-form-input v-model="loanApplication.disbursement_amt" number class="text-right" required
                                                  id="disbursement_amt"></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="4">
                                <b-form-group label="Paid Installment No" label-for="paid_installment_no" class="required">
                                    <b-form-input v-model="loanApplication.paid_installment_no " number required
                                                  id="paid_installment_no "></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="4">
                                <b-form-group label="Remaining Principal" label-for="remaining_principal" class="required">
                                    <b-form-input v-model="loanApplication.remaining_principal" number class="text-right" required
                                                  id="remaining_principal"></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="4">
                                <b-form-group label="Remaining Interest" label-for="remaining_interest" class="required">
                                    <b-form-input v-model="loanApplication.remaining_interest " number class="text-right" required
