<template>
  <b-form @submit.prevent="onSubmit" @reset.prevent="onReset">
    <b-card>
      <b-card-header header-bg-variant="dark" header-text-variant="white">Family Members</b-card-header>
      <b-card-body class="border">
        <b-row v-if="can_update">
            ...
            <b-row>
              ...
              <b-col md="4">
                <b-form-group
                  ...
                  <b-form-input
                    v-model="family.emp_member_name_bng"
                    class="uppercase"
              ...
              <b-col md="4">
                <b-form-group
                  ...
                  <b-form-input :maxlength="500" v-model="family.address_line_2"
                                class="uppercase" trim name="address_line_2"
                                id="address_line_2"></b-form-input>
                </b-form-group>
              </b-col>
              ...
              <b-col md="4">
                <b-form-group
                  ...
                  <div :class="{'invalid-feedback':true ,'d-block':$v.family.auth_id.$error && !$v.family.auth_id.required && family.auth_doc_type_id == ''}">Authentication id is required!</div>
              ...
              <b-col md="8">
                <b-input-group>
                  ...
                  <b-input-group-append v-if="family.emp_family_id && family.auth_attachment" style="width: 10%">
                    ...
                    >
                      <b-button style="margin-top: 20px" class="btn btn-primary" @click="showAttachment(family.auth_attachment)"> <i class="fa fa-download"></i> </b-button>
                    </b-form-group>

                  </b-input-group-append>
                  <div :class="{'invalid-feedback':true ,'d-block':$v.family.auth_attachment.$error && !$v.family.auth_attachment.required}">Authentication document is required!</div>
                </b-input-group>
              </b-col>
              <b-col md="4">
                <b-form-group
          ...
          <b-col md="2" class="text-center profileImage">
            <b-card class="m-0" style="border: 1px solid #eff1f2;">
              <b-card-text>
                <img id="nomineepic" :src="family.photo ? family.photo : '/images/avatar.png'" class="img-fluid">
              </b-card-text>
            </b-card>
            <label style="width:100%" class="btn btn-primary"> Upload Photo
              <input class="uploadImage" type="file" @change="getNomineePhoto" name="nominee_photo"/>
            </label>
          </b-col>
        </b-row>
        <b-row v-if="can_update">
        ...
        <Datatable v-bind:fields="fields" v-bind:items="items" :totalList="totalList" :perPage="perPage" :primaryKeyColumnName="'emp_family_id'">
          <template v-slot:actions="{ rows }">
            <b-link v-if="can_update" ml="4" class="text-primary" @click="editRow(rows.item)"><i class="bx bx-edit cursor-pointer"></i></b-link>
            <b-link v-if="can_update" class="text-danger" v-b-modal="'family-remove'" @click="deletedItem = rows.item"><i class="bx bx-trash cursor-pointer"></i></b-link>
            <a v-if="rows.item.auth_attach_file_name" size="sm" @click="showAttachment(rows.item.emp_family_id)"><i class="fa fa-download cursor-pointer"></i> </a>
          </template>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    {key: 'emp_member_mobile', label: "Mobile", sortable: true},
        ...
        watch: {
            maritalStatus:function(val,oldVal) {
                if(val !== null) {
                    ...
                    //this.family.marital_status_id = val.marital_status_id;
                } else {
        ...
        methods: {
            ...
            getAuthenticationUrl(emp_family_id){
                return 'pmis/employee/download-authentication-document/' + emp_family_id;
            },
            ...
            loadData: function () {
                if (this.hasEmpId()) {
                    ApiRepository.callApi(ApiRepository.GET_COMMAND, `/pmis/employee/families/specific/${this.id}`).then(res => {console.log(res)
                        ...
                        this.family.address_line_1 = res.data.empAddress ?  res.data.empAddress.address_line_1: '';
                        this.family.address_line_2 = res.data.empAddress ? res.data.empAddress.address_line_2: '';
                        ...
                        this.districts = res.data.empAddress ? res.data.empAddress.geo_district: '';
                        //this.districts = res.data.empAddress.geo_district;
                        this.thanas = res.data.empAddress ? res.data.empAddress.geo_thana: '';
                        //this.thanas = res.data.empAddress.geo_thana;
                        //this.family.post_code = res.data.empAddress.post_code;
                        this.family.post_code = res.data.empAddress ? res.data.empAddress.post_code: '';
            ...
            editRow(item) {
                ...
                this.maritalStatus = item.marital_status
                ...
                this.nomineeFor = item.nominee_info?item.nominee_info.nominee_for:{}
                this.relationTypes = {
                ...
                this.banks = item.nominee_info?item.nominee_info.bank:{}
                this.branches = item.nominee_info?item.nominee_info.branch:{}
