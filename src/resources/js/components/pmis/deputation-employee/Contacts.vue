                                    ...
                                    <b-row>
                                        ...
                                        <b-col md="3" class="contacts_btn">
                                            <b-button type="submit" id="basic_sub_btn"
                                                      class="btn btn-dark shadow mr-1" :disabled="keepDisable">{{submitBtn}}
                                            </b-button>
                                            <b-button type="reset" class="btn btn-outline-dark" :disabled="keepDisable">
                                                Cancel
                                            </b-button>
                                        </b-col>
                                    </b-row>
    ...
    export default {
        ...
        data() {
            return {
                ...
                submitBtn: 'Save',
                show: true,
                fields: [{key: 'index', label: 'SL'}, {key: 'contact_type.emp_contact_type', label: 'Contacts Type', sortable: true}, {key: 'emp_contact_info', label: 'Contact', sortable: true},'action'],
                items: [],
        ...
        methods: {
            ...
            onReset() {
                /*this.contactsList = [{'value': '', 'text': 'Select Contact type'}];*/
                this.updateIndex = -1;
                ...
                this.show = false;
                this.$nextTick(() => {
                    this.contacts.emp_contacts_id = '';
                    this.contacts.emp_contact_type_id='';
                    this.contacts.emp_contact_info='';
                    this.show = true
                })
            },
