            ...
            <b-card-body class="pills-stacked  pt-0">
                <b-row>
                    ...
                    <b-col md="10" sm="12" class="pr-md-0">
                                ...
                                <b-form @submit.prevent="onSubmit" @reset.prevent="onReset" v-if="show">
                                    <b-row class="mt-2">
                                        ...
                                        <b-col md="3">
                                            ...
                                            >
                                                <date-picker v-model="training.training_start_date"  input-class="form-control" width="100%"  type="date" lang="en" format="DD-MM-YYYY" :value-type="valueType" :editable="false" :not-after="notAfterToday()"></date-picker>
                                            </b-form-group>
                                        </b-col>
                                        <b-col md="3">
                                            <b-form-group
                                            ...
                                            >
                                                <date-picker v-model="training.training_completion_date"  input-class="form-control" width="100%"  type="date" lang="en" format="DD-MM-YYYY" :value-type="valueType" :editable="false" :not-after="notAfterToday()" :disabled = "keepDisabledEndDate" :not-before="notBeforeStartDate()"></date-picker>
                                            </b-form-group>
                                        </b-col>
                                        <b-col md="3">
                                            <b-form-group
                                        ...
                                        <b-col md="6">
                                            ...
                                            >
                                                <b-form-textarea
                                                    ...
                                                    placeholder="Trainng Description"
                                                ></b-form-textarea>
                                            </b-form-group>
                                        </b-col>
                                        <b-col md="6">
                        ...
                        <b-card title="Training Information List">
                            <b-card-body class="border">
            ...
            getTrainingDuration(start_date, end_date) {
             ...
             notBeforeStartDate() {
                 if(this.training.training_start_date) {
                     return moment(this.training.training_start_date).add('1', 'days');
                 }
             },
