    ...
    <div class="content-body">
        <b-card class="bg-transparent">
            <b-card-body class="pills-stacked  pt-0">
                <div class="row">
                    <div class="col-md-2 col-sm-12 border pr-md-0">
                        <SideBar :empId="id" class="mt-1"></SideBar>
                    </div>
                    <div class="col-md-10 col-sm-12 pr-md-0">
                        ...
                        <b-card title="Experience List">
                                    <b-card-body class="border">
                                        <Datatable v-bind:fields="tableData.fields"
                                                   ...
                                                   :primaryKeyColumnName="'experience_id'">
            ...
            return {
                ...
                tableData: {
                    fields: [
                        ...
                        {
                            key: "work_from", sortable: true, filterByFormatted: true, sortByFormatted: true,
                            formatter: value => {
                                if (value) {
                        ...
                        {
                            key: "work_to",
                            label: 'work till', sortable: true, filterByFormatted: true, sortByFormatted: true,
                            formatter: value => {
                                if (value) {
                                    return moment(value).format('DD-MM-YYYY');
                                }
