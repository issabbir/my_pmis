<template>
    <div class="content-wrapper">
        <div class="content-body">
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">In Academic Search </b-card-header>
                <b-card-body class="border">
                    <b-form>
                        <b-row>
                            ...
                            <b-col md="4">
                                <b-button type="submit" id="basic_sub_btn" @click="academicSearch" class="btn btn-dark shadow mr-1 mb-1">Search</b-button>
                            </b-col>
                        </b-row>
            ...
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">Pending In Academic For Approval</b-card-header>
                <b-card-body class="border">
                    <b-form
    ...
    export default {
            ...
            return{
                ...
                tableData: {
                    fields: [
                        ...
                        {key: 'exam_body_name', label: 'Board Name', sortable: true},
                        {key: 'institute_name', label: 'Institution Name', sortable: true},
                        {key: 'subject', label: 'Subject Name', sortable: true},
                        // {key:'update_date', formatter: value => {
                        //         if(value) {
        ...
        methods: {
            academicSearch() {
                ...
                ApiRepository.callApi(ApiRepository.GET_COMMAND, `/pmis/unapproved-academic-list?emp_id=`+empId).then(res => {
            ...
            changeStatus(item) {
                ...
                ApiRepository.callApi(ApiRepository.GET_COMMAND, '/pmis/employee/nominees/update-academic-yn/'+item.nominee_id+'/'+status, items).then(res => {
                    if (res.data.status) {
            ...
            onProcess() {
                ...
                let empId = this.inChargeSearch.emp_id;
                ApiRepository.callApi(ApiRepository.PUT_COMMAND, `/pmis/approve-academic?emp_id=`+empId, obj).then(res => {
