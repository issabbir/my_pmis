<template>
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <b-card  title="Fresh Water Assign">
            ...
            <b-card class="card">
                <b-row>
                    <b-col>
                        <b-card title="Fresh Water Assign List">
                            <b-row>
                            ...
                            <b-table striped hover show-empty
                                     ...
                                     <template v-slot:cell(veselAssgined)="row">
                                            <b-form-select v-model="involvement" :options="veselAssginedList"></b-form-select>
                                    </template>

                                    <template v-slot:cell(action)="row">
                                        <b-button variant="dark">Assign</b-button>                           
                                    </template>
                            </b-table>
        ...
        data() {
            ...
            fields: [
                ...
                {key: 'expDelivery', label: 'Exp. Delivery', sortable: true, sortDirection: 'desc', class: 'text-center'},
                 {key: 'approvedBy', label: 'Approved By', sortable: true, sortDirection: 'desc', class: 'text-center'},
                {key: 'veselAssgined', label: 'vesel', sortable: true, sortDirection: 'desc', class: 'text-center'},'action',
                {key: 'delivery', label: 'Delivery', sortable: true, sortDirection: 'desc', class: 'text-center'}
                ],
                items: [
                {sLNo: '1', veselName: 'MV Simon', shippingCo: 'Sikdar Shipping', qty: '200', anchorage: 'Alpha', expDelivery: '05-11-19', approvedBy: 'Doc Master',  veselAssgined: '',  action: '',  delivery: 'Pending'},
                {sLNo: '2', veselName: 'MV Augusta', shippingCo: 'Monsur Shipping', qty: '300', anchorage: 'Bravo', expDelivery: '07-11-19',  approvedBy: 'Doc Master', veselAssgined: '',  action: '', delivery: 'Delivered'},
                {sLNo: '3', veselName: 'MV Sea Queen', shippingCo: 'See Pearl Shipping', qty: '500', anchorage: 'Charlie', expDelivery: '09-11-19', approvedBy: 'Doc Master',  veselAssgined: '', action: '',  delivery: 'Delivered'},
                ],
                totalRows: 1,
                currentPage: 1,
                perPage: 5,
               ...
               // selected: [1],
                        veselAssginedList: [
                            {value: 1, text: 'Jalpari 01'},
                            {value: 2, text: 'Jalpari 02'},
                            {value: 2, text: 'Jalpari 03'},
                        ],
