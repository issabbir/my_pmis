<template>
    ...
    <div class="content-wrapper">
        <div class="content-body">
            <b-card title="Shed Delivery Order">
                        ...
                        <b-col>
                            <b-row >
                                <b-col>
                                    <b-row class="my-1">
                                        ...
                                        <b-col sm="9">
                                            <b-form-input v-model="marine.incident.incidentID20" type="text" ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                                <b-col>
                                    <b-row class="my-1">
                                        ...
                                        <b-col sm="9">
                                            <b-form-input v-model="marine.incident.incidentID21" type="text" ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                                <b-col>
                                    <b-row class="my-1">
                                        <b-col sm="3">
                                            <label>For Goods Ex. S.S</label>
                                        </b-col>
                                        <b-col sm="9">
                                            <b-form-input v-model="marine.incident.incidentID22" type="text" ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                            ...
                            <b-row class="col-md-">
                                <b-col>
                                    <b-row class="my-1">
                                        ...
                                        <b-col sm="9">
                                            <b-form-input v-model="marine.incident.incidentID23" type="text" ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                                <b-col>
                                    <b-row class="my-1">
                                        ...
                                        <b-col sm="9">
                                            <b-form-input v-model="marine.incident.incidentID25" type="text"  ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                                <b-col>
                            ...
                            <b-row class="col-md-">
                                <b-col>
                                    <b-row class="my-1 ">
                                        <b-col sm="3">
                                            <label>Shed/Yard No.</label>
                                        </b-col>
                                        <b-col sm="9" >
                                            <b-form-input v-model="marine.incident.incidentID24" type="text"  ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                                <b-col>
                                    <b-row class="my-1 ">
                                        <b-col sm="3">
                                            <label>If R/B.E No.</label>
                                        </b-col>
                                        <b-col sm="9" >
                                            <b-form-input v-model="marine.incident.incidentID26" type="text"  ></b-form-input>
                                        </b-col>
                                    </b-row>
                                </b-col>
                                <b-col>
