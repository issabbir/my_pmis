<template>
    <b-container fluid>
        <b-form @submit.prevent="onSearchData" @reset.prevent="onReset">
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">Unregistered Overtime</b-card-header>
                <b-card-body class="border">
                    <b-row>
                        <b-col md="3">
                            <label for="departmentID">Department<span class="text-danger">*</span></label>
                            <b-form-select id="departmentID" v-model="irregularOvertime.department" required
                                           :options="departmentList"></b-form-select>
                        </b-col>
                        <b-col md="3">
                            <label for="otMonth">Month<span class="text-danger">*</span></label>
                        ...
                        <b-col md="3">
                            ...
                            <b-form-select id="otMonthSlab" v-model="irregularOvertime.otMonthSlab"
        ...
        <b-card title="Unregistered Overtime list" class="ot-irr-form">
            <b-card-text>
                <b-form-checkbox
                    v-model="allSelected"
