                                        ...
                                        <b-card class="ovetimeProcessApproval" :title="personwiseTitle">
                                            <b-card-text>
                                                        ...
                                                        <template  v-slot:roster_date="{ rows }">
                                                            ...
                                                            <template  v-slot:action3="{ rows }">
                                                             ...
                                                             >
                                                                ...
                                                                <!--
                                                                     @change="calculate_ot_datetime_diff(rows.item.ot_start_time,rows.item.ot_end_time,rows)"
                                                              @input="calculate_ot_datetime_diff(rows.item.ot_start_time,rows.item.ot_end_time,rows)"



                                                              :not-before="rows.item.only_start_date+' 00:00:01'"
                                                             :not-after="rows.item.only_end_date+' 23:59:59'"
                                                                    <b-form-select v-model="rows.item.ot_start_time"
                                                                :options="startTimeRange24"></b-form-select> -->
                                                            <!-- <b-form-input type="text" value="{rows.item.roster_date}"  v-model="rows.item.ot_start_time"></b-form-input> -->
                                                        </template>
                                                        <template  v-slot:action4="{ rows }">
                                                            ...
                                                            <!-- <b-form-select v-model="rows.item.ot_end_time"
                                                                :options="endTimeRange24"></b-form-select> -->
                                                        </template>
