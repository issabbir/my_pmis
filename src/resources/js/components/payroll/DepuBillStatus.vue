    ...
    export default {
        ...
        methods: {
            ...
            addState: function(state) {
                ...
                ApiRepository.callApi(ApiRepository.POST_COMMAND, '/deputation-payroll/bonus/'+this.process.bill_code+'/status/'+this.process.pr_month+'/'+this.process.bonus_head, state).then(res => {
            ...
            getBillStatus: function() {
                ApiRepository.callApi(ApiRepository.GET_COMMAND, '/deputation-payroll/bonus/'+this.process.bill_code+'/status/'+this.process.pr_month+'/'+this.process.bonus_head).then(res => {
                    this.billStates = res.data.bill_status;
                    this.nextState = res.data.next_status;
                    this.currentStatus = res.data.current_status;
                    this.options = res.data.options;
            ...
            billDisbursement: function() {
                ...
                state.month_id = this.process.pr_month;
                state.head = this.process.bonus_head;
                ApiRepository.callApi(ApiRepository.POST_COMMAND, '/deputation-payroll/bonus-disburse', state).then(res => {
                    this.billStates = res.data.bill_status;
                    this.nextState = res.data.next_status;
                    this.currentStatus = res.data.current_status;
                    this.options = res.data.options;
