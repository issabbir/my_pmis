<template>
    <b-form @submit="onSubmit" @reset="onReset">
        <b-card title="Leave Pending Info">
            <b-card-text>
                <b-row> 
                    <b-col>
                        <label for="department">EMPLOYEE ID</label>
                        <b-form-input id="department" v-model="form.department" type="text" placeholder="Employee ID">></b-form-input>
                    </b-col>
                    <b-col>
                        <label  for="section">EMPLOYEE NAME</label>
                        <b-form-input  id="section" v-model="form.section" type="text" placeholder="Employee Name"></b-form-input>
                    </b-col> 
                </b-row> 
            </b-card-text>
            <b-row class="mt-3">
