<template>
    <div class="content-wrapper">
        <div id="content-body">
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white"ph>Employee Pension </b-card-header>
                    ...
                    <b-row class="d-flex justify-content-start">
                        ...
                        <b-col md="3">
                            <b-form-group
                                ...
                                label="Employee Type"
                            >
                                <b-form-select v-model="pensionHeadObj.empType" name="empType"
                        ...
                        <b-col md="3">
                            ...
                            >
                                <b-form-select v-model="pensionHeadObj.pensionCat" name="pensionCat"
            ...
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">Pension Employee List
                ...
                <b-card-body class="border">
                    <Datatable v-bind:fields="tableData.fields" v-bind:items="tableData.items" :totalList="totalList" :perPage="perPage"></Datatable>
                </b-card-body>
            </b-card>
            <b-modal v-model="approveShow" size="xl" okTitle="Submit" :hide-footer=true :hide-header=true>
                <b-row >
                    <b-col>
                        <h4>{{'Monthly pension approval process'}}</h4>
                    </b-col>
                    <b-col class="d-flex justify-content-end">
...
<script>
    ...
    export default {
            ...
            return {
                ...
                tableData: {
                    fields: [
                        ...
                        {key: 'medical_amount', label: 'Medical Amount' ,  class: 'text-right',sortable: true},
        ...
        mounted() {
            ...
            this.$store.commit("setBreadcrumb", {link: "#", label: "Employees Pension"});
            this.allSalarySetup();
            this.changeYear();
            this.preLoadData();
            this.loadWorkflow();
        ...
        methods: {
            ...
            search: function() {
                ApiRepository.callApi(ApiRepository.POST_COMMAND, '/pension/monthly-pension-process-data',this.pensionHeadObj).then(res => {
