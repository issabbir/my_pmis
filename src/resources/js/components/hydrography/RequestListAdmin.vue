                            ...
                            <b-card title="Hydrography Customer Request List">
                                ...
                                <b-table striped hover show-empty
                                    ...
                                    <template v-slot:cell(action)="row">
                                        ...
                                        <a target="_self" href="/hydrography/#/invoice" class="text-primary"><i class="bx bx-show  cursor-pointer"></i></a>
    ...
    export default {
        ...
        data(){
            return {
                ...
                show: true,
                tableData: {
                    fields: [{key: 'exam_body_id', label: 'ID', sortable: true}, {key: 'name', sortable: true}, {key: 'description', sortable: true}, {key: 'exam_body_type.name', "label": "type", sortable: true}, {key: 'action', sortable: false}],
                    items:[]
                },
