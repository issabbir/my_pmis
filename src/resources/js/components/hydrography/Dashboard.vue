                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-end">
                                            ...
                                            <div class="dashboard-content-right">
                                                <img src="../../../images/icon/cup.png" height="220" width="220" class="img-fluid"
...
<script>
    export default {
        ...
        mounted() {
            ...
            // let label = "google.com";
            // //this.$store.commit("setBreadcrumbEmpty");
            // this.$store.commit("setBreadcrumb", {link, label});
            this.$store.commit("setBreadcrumb", { link: "#", label: "Hydrography" });
            this.$store.commit("setBreadcrumb", { link: "#", label: "Dashboard" });
        },
        data() {
            return {
                "breadCrumbs":""
