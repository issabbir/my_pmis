        ...
        <b-col>
          <b-card class="card">
            <div class="card-header">
              <h4 class="card-title">Fixed Deposit Details</h4>
            </div>
                          ...
                          <b-row>
                            <b-col class="mt-2 d-flex justify-content-end">
                              <b-button lg="6" size="md" class="btn-outline-dark"
                                        v-on:click="isHidden = !isHidden"   type="reset">
                    ...
                    <b-card class="card">
                        <div class="card-content">
                            <b-card-text class="card-body">
                                <h4 class="card-title">FDR Details</h4>
                                    ...
                                    <div class="col-lg-5 col-md-7 offset-lg-2 col-12">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                <span class="invoice-subtotal-title">Total FDR Amount:</span>
                                                <h6 class="invoice-subtotal-value mb-0">100000</h6>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                <span class="invoice-subtotal-title">Total Gross Interest:</span>
                                                <h6 class="invoice-subtotal-value mb-0">8000</h6>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                <span class="invoice-subtotal-title">Total Source Tax:</span>
                                                <h6 class="invoice-subtotal-value mb-0">800</h6>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                <span class="invoice-subtotal-title">Total Amount:</span>
                                                <h6 class="invoice-subtotal-value mb-0">180000</h6>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                <span class="invoice-subtotal-title">Total Excise Duty:</span>
                                                <h6 class="invoice-subtotal-value mb-0">500</h6>
                                            </li>
                                            <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                <span class="invoice-subtotal-title">Total Net Income:</span>
                                                <h6 class="invoice-subtotal-value mb-0">71586</h6>
                                            </li>
                                            <hr />
...
export default {
  ...
  mounted() {
    this.$store.commit("setBreadcrumbEmpty");
      ...
      this.$store.commit("setBreadcrumb", {link: "#", label: "FDR Details"});
