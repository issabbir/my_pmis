                ...
                <b-col>
                    <b-card class="card">
                        <div class="card-header">
                            <h4 class="card-title">CTMS Vessel Billing</h4>
                        </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.$store.commit("setBreadcrumb", {link: "#", label: "CTMS Billing"});
        },
        data() {
            return {
                form: {
                ...
                vesselFields: [
                    ...
                    {key: 'vat', label: 'VAT', sortable: true, sortDirection: 'desc', class: 'text-center'},'totalAmt'
                ],
                vesselItems: [
                    {uom: '1010', rate: 'Item', qty: '10000.00', move: 'Outer', amount: '378900', vat:''},
                    {uom: '1010', rate: 'Item', qty: '10000.00', move: 'Outer', amount: '378900', vat:''},
