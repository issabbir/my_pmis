        ...
        <div class="content-body">
            <b-card class="card">
                <div class="card-header">
                    <h4 class="card-title">Approval for GPF/CPF Loan</h4>
                </div>
                        ...
                        <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                                ...
                                <b-col md="4">
                                    <b-form-group>
                                        <b-row>
                                            ...
                                            <b-col md="8">
                                                <b-form-select v-model="form.department" :options="departmntList"></b-form-select>
                                            </b-col>
                                        </b-row>
                                    </b-form-group>
                                ...
                                <b-col md="4">
                                    <b-form-group>
                                        <b-row>
                                            ...
                                            <b-col md="8">
                                                <b-form-select v-model="form.section" :options="sectionList"></b-form-select>
                                            </b-col>
                                        </b-row>
                                    </b-form-group>
                                ...
                                <b-col md="4">
                                    <b-form-group>
                                        <b-row>
                                            ...
                                            <b-col md="8">
                                                <b-form-select v-model="form.empId" :options="empList"></b-form-select>
                                            </b-col>
                                        </b-row>
                                    </b-form-group>
                                </b-col>
                            ...
                            <b-row>
                                <b-col class="mt-2 d-flex justify-content-end">
                                    <b-button md="6"  size="md" variant="dark" type="submit" >Process</b-button>&nbsp;
            ...
            <b-card class="card">
                <b-row>
                    <b-col>
                        <b-card title="Loan Application Data">
                            <b-row>
                            ...
                            <b-table striped hover show-empty
                                ...
                                <a size="sm"  class="text-primary" data-toggle="modal" href="#" data-target="#border-less"><i class="bx bx-check cursor-pointer"></i> </a>
                                <a size="sm"  class="text-primary"  href="/approval_service/#/approve-cpfdtl" ><i class="bx bx-file cursor-pointer"></i> </a>
                                 <a target="_self" href="#" class="text-danger"><i class="bx bx-x cursor-pointer"></i></a>
                            </template>
