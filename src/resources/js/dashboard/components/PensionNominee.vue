            ...
            <b-card-body class="border">
                ...
                <b-table small responsive :items="temp_item" :fields="temp_fields">
                    ...
                    <template v-slot:cell(action)="{ item, index }">
                        <b-button size="sm" @click="item.edit_yn = 'Y'" variant="warning">Edit</b-button>
                        <b-button size="sm" @click="onDelete(item.nominee_id)" variant="danger">Delete</b-button>
                    </template>
...
<script>
    ...
    export default {
        ...
        watch: {
            ...
            temp_item: {
                ...
                handler(val, oldVal){
                    ...
                    // console.log('temp_item'+JSON.stringify(this.temp_item))
        ...
        filter:{
            // filterFamily: function (arr,value) {
            //     return arr.filter(function(el) {
            //         return el.toLowerCase().indexOf(query.toLowerCase()) !== -1
            //     });
            //      // if (this.nominee.emp_family_id == value.emp_family_id){
            //      //     return true;
            //      // }else {
            //      //     return false;
            //      // }
        ...
        methods: {
            ...
            calculatePercentage(item, index) {
                ...
                console.log('percentage'+this.totalPercentage)
            },
            loadFamilies(){
                if (this.hasEmpId()) {
            ...
            onSubmit() {
                ...
                if (!this.$v.nominee.$invalid){
                    if((this.totalPercentage + parseFloat(this.nominee.percentage)) >100){
                        ...
                        let fid = this.nominee.emp_family_id;
                        this.filterFamilies();
                        this.modelClear();
                    }
                }
