            ...
            <b-col md="4" >
                <b-card class="h-100">
                    <b-card-body>
                        ...
                        <b-form-group class="text-center">
                            <b-button @click="showModal" size="sm">Edit</b-button>
                        </b-form-group>
                    ...
                    <b-card-body>
                        ...
                        <b-row>
                            ...
                            <b-col md="6">
                                <b-form-group
                                    label="Actual Grade"
                                    label-for="actual_grade"
                                    label-align="right"
                                    label-cols-md="4">
                                    <b-form-input class="font-weight-bolder" :value="(!employee.actual_grade)?'':employee.actual_grade.text" id="grade_range" readonly></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="6">
                                <b-form-group
                            ...
                            <b-col md="6">
                                <b-form-group
                                    ...
                                    label-align="right"
                                    label-cols-md="4">
                                    <b-form-input class="font-weight-bolder" :value="(!employee.actual_grade)?'':employee.actual_grade.emp_class"" id="emp_class" readonly></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col md="6">
                                <b-form-group
...
<!--                        </b-col>-->
                ...
                <b-col md="3" class="text-center profileImage">
                    ...
                    <label style="width:100%" class="btn btn-primary"> Upload Photo
                        <input class="uploadImage"  type="file"  name="emp_photo" @change="getPhoto" accept=".jpg" v-validate="'image|size:100'" />
                    </label>
...
<script>
    ...
    export default {
        name: "Profile",
        components: {
            'single-lightbox': SingleLightbox, vSelect
        },
        data() {
            return {
                employeeList: [],
