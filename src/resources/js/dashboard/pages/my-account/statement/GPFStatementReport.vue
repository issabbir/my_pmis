<template>
    <div class="content-wrapper">
        <div class="content-body">
            <b-card>
                <b-card-header header-bg-variant="dark" header-text-variant="white">GPF Statement</b-card-header>
...
<!--                        &lt;!&ndash; <template slot="actions" v-bind:row="row">-->
...
<script>
    ...
    export default {
        ...
        mounted() {
            //console.log(this.$store.state.user.emp_id);
        ...
        methods: {
            ...
            // },
            currentEmployee() {
                    ApiRepository.callApi(ApiRepository.GET_COMMAND, `/pmis/employee/employeeProfile`, this.loanApplication).then(res => {
            ...
            renderPdf: function() {
               ...
               // this.reportParams.p_fy_id = this.searchParams.fy_id;
                /* this.reportParams.P_BILL_CODE = '';
                 this.reportParams.P_DEPARTMENT_ID = this.searchParams.department_id;*/
                this.reportParams.P_EMP_CODE = this.empIdList.emp_code;
                this.reportParams.P_DEPARTMENT_ID = this.empIdList.dpt_department_id;
                this.reportParams.P_BILL_CODE = this.empIdList.bill_code;
