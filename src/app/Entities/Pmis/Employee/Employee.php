...
class Employee extends Model
{
    ...
    protected $with = ['dptDivision','department','current_department', 'charge_designation', 'section', 'designation','grade','actualGrade', 'emp_status'];
...
//    }
    ...
    public function getDesignationAttribute() {
        if ($entity = $this->charge_designation)
            return $entity;

        $entity =  $this->designation();
        return $entity->first();
    }
